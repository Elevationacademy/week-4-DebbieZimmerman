...
// let fixedMessages = messagesFromDad.map((m) => m.toLowerCase())
// fixedMessages.forEach(m => console.log(m))

// //example using map to sort data
// let users = [
//     {
//     "name": "Leanne Graham",
//     "address": {
...
// //exercise 1
// const usersNew = users.map(u => {return {email: u.email, companyName: u.company.name}})
// console.log(usersNew) 

// //exercise 2
// const usersZip5 = users.filter(u => u.address.zipcode.charAt(0) == 5)
// console.log(usersZip5)

// //exercise 3
// const usersZip5 = users
...
//exercise 6
// const person = users.find(u => u.address.suite === "Apt. 950")
// console.log(person.company.name)

//exercise 7
// const description = user => console.log(`${user.name} lives in ${user.address.city}, and owns the company ${user.company.name}.`)
// users.forEach(u => description(u))